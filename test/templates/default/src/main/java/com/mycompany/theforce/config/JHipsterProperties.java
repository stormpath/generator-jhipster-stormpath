...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "TheForce@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "TheForce API";

        private String description = "TheForce API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "TheForce";
